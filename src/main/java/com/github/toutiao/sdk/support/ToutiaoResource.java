...
public class ToutiaoResource {
    ...
    public static <T extends ToutiaoResponse> T execute(HttpMethod httpMethod, String apiUrl, String payLoad,
                                                        Class<T> clazz, String accessToken) throws ToutiaoRestException {
    ...
    private static HttpsURLConnection httpsConnect(HttpMethod httpMethod, String apiUrl, String accessToken) throws IOException {
        ...
        connection.setRequestProperty("User-Agent", "Toutiao Marketing-api Java SDK");
        if (accessToken != null) {
    ...
    public static String request(HttpMethod httpMethod, String apiUrl, String payLoad, String token) throws ToutiaoRestException {
        try {
            ...
            if (error) {
                throw new ToutiaoRestException("api call error response: " + responseCode + " body " + responseString + " url=" + apiUrl);
            }
            return responseString;
        } catch (IOException e) {
            throw new ToutiaoRestException("api request io error, url=" + apiUrl, e);
        }
    }
